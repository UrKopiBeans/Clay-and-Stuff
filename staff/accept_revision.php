...
// same as owner/accept_revision.php, just different role check
// update_id = the progress update row the customer asked a revision on.
// this just accepts it, wala pang bagong photo, that's "Send Update".
...
// make sure update is still status "revision" for this order
