...
/* Owner portal sidebar (CSS + HTML + PHP sa iisang file) — include na lang sa bawat owner/*.php page.
   May Owner-only items (For Approval, User Management, Content Management) na wala sa Staff sidebar.
   Inline SVG icons (hindi Font Awesome CDN) para gumana kahit walang internet ang local server.
   !important sa font-size/spacing para pareho ang laki kahit anong page CSS ang huling na-load. */
...
/* Sa :root ito, hindi sa .sidebar, kasi ang modal/toast ay sibling ng <aside class="sidebar">
   — kung nasa .sidebar lang ang variables, hindi ma-inherit ng modal/toast (invisible logout button). */
:root {
    --sb-pink: #f78fd4;
    --sb-pink-dark: #b23e82;
...
/* Laging Segoe UI ang sidebar kahit may sariling "body" font rule ang na-load na page CSS. */
.sidebar,
.sidebar * {
...
/* brand/logo — logo sa kaliwa, "Clay and Stuff" na text sa tabi (hindi
   na nakapatong sa ibabaw), gamit ang naka-crop na logo (logoclay-sidebar.png)
...
/* nav links — nilakihan ang text/icons (mas madaling mabasa/makita)
   pero sinigurado na kasya pa rin lahat ng item nang walang scrollbar */
...
<aside class="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <a href="ownerdashboard.php" class="sb-nav-item <?php echo sb_active('ownerdashboard.php', $sidebarCurrentPage); ?>">
        ...
        <a href="for-approval.php" class="sb-nav-item <?php echo sb_active('for-approval.php', $sidebarCurrentPage); ?>">
            <span class="sb-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 8v5"/><path d="M12 16h.01"/></svg></span>
        ...
        <a href="user-management.php" class="sb-nav-item <?php echo sb_active('user-management.php', $sidebarCurrentPage); ?>">
            <span class="sb-icon"><svg viewBox="0 0 24 24"><circle cx="8.5" cy="8" r="3.2"/><path d="M2.5 20c0-3.6 2.7-6 6-6s6 2.4 6 6"/><circle cx="17.5" cy="7.5" r="2.2"/><path d="M15.5 20c.2-2.4 1.6-4 3.6-4.6"/></svg></span>
            <span>User Management</span>
        </a>

        <a href="content-management.php" class="sb-nav-item <?php echo in_array($sidebarCurrentPage, ['content-management.php', 'collection-management.php'], true) ? 'active' : ''; ?>">
            <span class="sb-icon"><svg viewBox="0 0 24 24"><path d="M14 4l6 6-9 9H5v-6z"/><path d="M4 21h16"/></svg></span>
        ...
        <a href="activity-log.php" class="sb-nav-item <?php echo sb_active('activity-log.php', $sidebarCurrentPage); ?>">
            <span class="sb-icon"><svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg></span>
...
(function () {
    ...
    var logoutHref = "../Login/logout.php?portal=owner";
